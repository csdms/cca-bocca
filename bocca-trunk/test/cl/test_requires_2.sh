...
if ! test -d "$2/req2/myproj/BOCCA"; then
...
make
echo "TRYING"
echo "$1 create component mypkg.mycomp --provides=mypkg.foo@myfoo --requires=gov.cca.ports.BuilderService"
$1 create component  mypkg.mycomp --provides=mypkg.foo@myfoo --requires=gov.cca.ports.BuilderService
