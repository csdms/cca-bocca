...
def getWriterParameters():
     return (F77Writer.language, F77Writer.babelVersions, F77Writer.dialect)
 
# note that f7731 is not a dialect, but a separate babel language.
...
C       Insert-Code-Here {@CMPT_TYPE@.setServices} (setServices method prolog)
...
C       Insert-Code-Here {@CMPT_TYPE@.setServices} (setServices method epilog)
