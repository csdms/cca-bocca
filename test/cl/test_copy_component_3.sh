...
if ! test -d "$2/cocopy3/myproj/BOCCA"; then
...
$1 copy component --no-impl mypkg.comp mypkg.comp2
...
grep -e "TEST: INCLUDED" components/mypkg.comp2/mypkg_comp2_Impl.cxx

if ! test "x$?" = "x1"; then
    echo "mypkg.comp implementation merged into mypkg.comp2 implementation"
    echo "FAIL"
    exit 1
fi
