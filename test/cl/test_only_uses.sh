...
if ! test -d "$2/uo1/myproj/BOCCA"; then
...
echo "TRYING"
echo "$1 create component mypkg.mycomp  -lcxx --uses=mypkg.foo@yourfoo"
...
echo "$1 create component mypkg.mycomp$LANG  -l$LANG --uses=mypkg.foo@yourfoo"
